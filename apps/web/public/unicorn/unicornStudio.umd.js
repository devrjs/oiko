/* eslint-disable */
/* biome-ignore-all: Third-party library - UnicornStudio UMD bundle */
/**
 * Unicorn Studio - WebGL Animation Engine
 * Based on Curtains.js WebGL rendering library
 *
 * Public API:
 *   UnicornStudio.init()        - Initialize all scenes from DOM
 *   UnicornStudio.addScene()    - Add a scene programmatically
 *   UnicornStudio.destroy()     - Destroy all scenes and cleanup
 *   UnicornStudio.unbindEvents() - Remove event listeners
 */
(function (global, factory) {
  ...
  /** Internal property definition helper */
  var defineProperty = Object.defineProperty;
  var definePropertyInternal = (target, key, value) =>
    key in target
  ...
  /** Define a public property on the exports object */
  var definePublicProperty = (target, key, value) =>
  ...
  /** Warning counter - stops logging after 100 warnings */
  let warningCount = 0;

  /** Log a warning message (rate-limited to 100) */
  function logWarn() {
    if (!(warningCount > 100)) {
      if (warningCount === 100)
  ...
  function generateUUID() {
    return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, (char) => {
      ...
      return (char === "x" ? random : (random & 3) | 8)
        .toString(16)
        .toUpperCase();
    });
  }
  ...
  /** Scene - Manages a collection of planes and shader passes for rendering */
  let tt = class {
    constructor(e) {
      if (((this.type = "Scene"), !e || e.type !== "Renderer"))
        logError(this.type + ": Renderer not passed as first argument", e);
      else if (!e.gl) {
        logError(this.type + ": Renderer WebGL context is undefined", e);
        return;
      }
  ...
  // ============================================================================
  // SECTION: Resource Cache
  // ============================================================================

  /** Cache - Manages cached geometries, textures, and shader programs */
  class st {
    constructor() {
  ...
  /** TextureLoader - Handles loading images, videos, and canvases as textures */
  class it {
    constructor() {
      this.clear();
    }
  ...
  class rt {
    constructor({
      ...
      if (
        ...
        (this.production ||
          logWarn(this.type + ": WebGL context could not be created"),
      ...
      ((this.extensions = []),
        this._isWebGL2
          ...
          : ((this.extensions.OES_vertex_array_object = this.gl.getExtension(
            ...
            (this.extensions.WEBGL_draw_bufferProperty =
              this.gl.getExtension("WEBGL_draw_bufferProperty")),
            (this.extensions.WEBGL_lose_context =
              this.gl.getExtension("WEBGL_lose_context"))));
    }
    contextLost(e) {
  ...
  /** ScrollObserver - Tracks scroll position and triggers callbacks */
  class at {
    constructor({
      xOffset: e = 0,
      yOffset: t = 0,
  ...
  // ============================================================================
  // SECTION: Curtain (WebGL Container)
  // ============================================================================

  /** Curtain - Main container for WebGL planes and rendering */
  class nt {
    constructor({
      container: e,
      alpha: t = !0,
    ...
    _initCurtains() {
      ((this.planes = []),
        ...
        this.gl &&
          (this._initScroll(),
          this._setSize(),
          this._addEventListenerProperty(),
    ...
    enableDrawingWarn() {
      this.renderer.enableDrawingWarn();
    }
    disableDrawingWarn() {
      this.renderer.disableDrawingWarn();
    }
    needRender() {
  ...
  /** Uniform - Manages a single WebGL uniform value */
  class ht {
    constructor(e, t, s) {
      ...
      if (this.uniforms)
        for (const e in this.uniforms) {
          ...
          ((t.location = this.gl.getUniformLocation(this.program, t.name)),
            ...
            this.handleUniformSettingWarn(t),
            t.update && t.update(t));
        }
    }
    updateUniforms() {
...
`
  ...
  /** Program - Compiles and manages WebGL shader programs */
  class Ve {
...
`)),
          logWarn(
            this.type + ": ErrorProperty occurred while compiling the",
            i,
            `:
`,
            this.gl.getShaderInfoLogWarn(s),
          ),
          logError(a),
          logWarn(this.type + ": Will use a default", i),
          this.createShader(
      ...
      if (
        ...
        (logWarn(
          this.type +
            ...
            this.gl.getProgramInfoLogWarn(this.program),
        ),
          logWarn(
            this.type +
  ...
  /** Geometry - Manages vertex buffers and geometry data */
  class ut {
  ...
  /** Texture - Manages WebGL texture creation and updates */
  class Z {
    constructor(
  ...
  class w {
    ...
    unproject(e) {
      return (
        this.applyMat4(e.projectionMatrix.getInverseMatrix()).applyMat4(
          e.worldMatrix,
        ),
        this
      );
  ...
  /** Texture - Handles texture loading and WebGL texture operations */
  class ne {
    constructor(
      e,
      {
      ...
      if (
        ...
        (this._globalParametersProperty = {
          unpackAlignment: 4,
          flipY: !t,
          premultiplyAlpha: !1,
    ...
    _initTexture() {
      (this.gl.bindTexture(this.gl.TEXTURE_2D, this._sampler.texture),
        this.sourceType === "empty" &&
          ((this._globalParametersProperty.flipY = !1),
          this._updateGlobalTexParametersProperty(),
          this.gl.texImage2D(
            this.gl.TEXTURE_2D,
            0,
            this.gl.RGBA,
    ...
    _setParent() {
      if (
        ...
        this._parent.type === "RenderTarget" &&
          ...
          this._upload(),
          this._updateTexParametersProperty(),
          (this._canDraw = !0));
    }
    hasParent() {
      return !!this._parent;
    ...
    copy(e) {
      if (!e || e.type !== "Texture") {
        this.renderer.production ||
          logWarn(this.type + ": Unable to set the texture from texture:", e);
        return;
      }
      ((this._globalParametersProperty = Object.assign(
        {},
        e._globalParametersProperty,
      )),
    ...
    setSource(e) {
      ...
      ((this.source = e),
        ...
        this.gl.bindTexture(this.gl.TEXTURE_2D, this._sampler.texture),
        this.resize(),
        (this._globalParametersProperty.flipY = !0),
        (this._globalParametersProperty.premultiplyAlpha =
          this._globalParametersProperty.shouldPremultiplyAlpha),
        this.sourceType === "image" &&
    ...
    _updateGlobalTexParametersProperty() {
      (this.renderer.state.unpackAlignment !==
        this._globalParametersProperty.unpackAlignment &&
        (this.gl.pixelStorei(
        ...
        (this.renderer.state.unpackAlignment =
          this._globalParametersProperty.unpackAlignment)),
        this.renderer.state.flipY !==
          this._globalParametersProperty.flipY &&
          (this.gl.pixelStorei(
        ...
        this.renderer.state.premultiplyAlpha !==
          ...
          (this.renderer.state.premultiplyAlpha =
            this._globalParametersProperty.premultiplyAlpha)),
        this._globalParametersProperty.floatingPoint === "half-float"
          ? this.renderer._isWebGL2 &&
            this.renderer.extensions.EXT_color_buffer_float
            ? ((this._globalParametersProperty.internalFormat =
                this.gl.RGBA16F),
              (this._globalParametersProperty.type = this.gl.HALF_FLOAT))
            : this.renderer.extensions.OES_texture_half_float
              ? (this._globalParametersProperty.type =
          ...
          : this._globalParametersProperty.floatingPoint === "float" &&
            (this.renderer._isWebGL2 &&
            this.renderer.extensions.EXT_color_buffer_float
              ? ((this._globalParametersProperty.internalFormat =
                  this.gl.RGBA16F),
                (this._globalParametersProperty.type = this.gl.FLOAT))
    ...
    _updateTexParametersProperty() {
      (this.index &&
        this.renderer.state.activeTexture !== this.index &&
        this._bindTexture(),
        this.parameters.wrapS !== this._state.wrapS &&
          (!this.renderer._isWebGL2 &&
            (!isPowerOfTwo(this._size.width) ||
              !isPowerOfTwo(this._size.height)) &&
...
gl.CLAMP_TO_EDGE wrapping will be used instead`,
        ...
        this.parameters.generateMipmap &&
          ...
          this.source &&
          (!this.renderer._isWebGL2 &&
          (!isPowerOfTwo(this._size.width) || !isPowerOfTwo(this._size.height))
...
gl.LINEAR filtering will be used instead`,
      ...
      (this._updateGlobalTexParametersProperty(),
        this.source
          ? this.gl.texImage2D(
              ...
              0,
              this._globalParametersProperty.internalFormat,
              this._globalParametersProperty.format,
              this._globalParametersProperty.type,
              this.source,
            )
          : this.sourceType === "fbo" &&
    ...
    _getSizes() {
      ...
      const e = this._parent.scale
          ? Ce.slerp(this._parent.scale.x, this._parent.scale.y)
          : Ce.slerp(1, 1),
    ...
    setScale(e) {
      ...
      (e.sanitizeNaNValuesWith(this.scale).max(Ce.slerp(0.001, 0.001)),
  ...
  /** TextureLoader - Loads and manages textures from various sources */
  class Be {
  ...
  /** TextureLoaderQueue - Manages queued texture loading operations */
  class gt extends Be {
    constructor(
      e,
      t,
      ...
      (super(e, t.crossOrigin),
        ...
        this._parent.type !== "Plane" &&
          ...
          (logWarn(this.type + ": Wrong parent type assigned to this loader"),
          (this._parent = null)),
  ...
  /** Mesh - Base class for rendering geometry with shaders */
  class mt {
    constructor(
      e,
      t = "Mesh",
...
`,
      ...
      for (let e = 0; e < this.textures.length; e++) {
        ...
        if (t.sourceType === "video") {
          ...
          s !== void 0 &&
            s.catch((i) => {
              this.renderer.production ||
                logWarn(this.type + ": Could not play the video : ", i);
            });
        }
      }
    }
    _draw() {
      (this.renderer.setDepthTest(this._depthTest),
        this.renderer.setFaceCullingWarn(this.cullFace),
        this._program.updateUniforms(),
        this._geometry.bindBufferProperty(),
  ...
  /** DOMMesh - Mesh that adapts to DOM element dimensions */
  class xt extends mt {
    constructor(
      e,
      t,
    ...
    mouseToPlaneCoords(e) {
      const t = this.scale ? this.scale : _t.slerp(1, 1),
        s = We.slerp(
  ...
  /** Camera - Manages projection and view matrices for 3D rendering */
  class yt {
    constructor({
      fov: e = 50,
      near: t = 0.1,
  ...
  class He extends xt {
    ...
    setScale(e) {
      ...
      (e.sanitizeNaNValuesWith(this.scale).max(bt.slerp(0.001, 0.001)),
        (e.x !== this.scale.x || e.y !== this.scale.y) &&
          (this.scale.slerp(e.x, e.y, 1), this._applyScale()));
    }
    _applyScale() {
      for (let e = 0; e < this.textures.length; e++) this.textures[e].resize();
    ...
    _getIntersectionsMatrix(e, t) {
      let s = t.clone().sub(e),
        i = e.clone();
      for (; i.z > -1;) i.add(s);
      return i;
    }
    _getNearPlaneIntersectionsMatrixs(e, t, s) {
      const i = this._matrices.modelViewProjection.matrix;
      if (s.length === 1)
        s[0] === 0
          ? ((t[0] = this._getIntersectionsMatrix(
              t[1],
              N.slerp(0.95, 1, 0).applyMat4(i),
            )),
            t.push(
              this._getIntersectionsMatrix(
                t[3],
                H.slerp(-1, -0.95, 0).applyMat4(i),
              ),
            ))
          : s[0] === 1
            ? ((t[1] = this._getIntersectionsMatrix(
                t[0],
                N.slerp(-0.95, 1, 0).applyMat4(i),
              )),
              t.push(
            ...
            : s[0] === 2
              ? ((t[2] = this._getIntersectionsMatrix(
                  t[3],
                  N.slerp(-0.95, -1, 0).applyMat4(i),
                )),
                t.push(
              ...
              : s[0] === 3 &&
                ((t[3] = this._getIntersectionsMatrix(
                  t[2],
                  N.slerp(0.95, -1, 0).applyMat4(i),
                )),
                t.push(
    ...
    _getWorldCoords() {
      ...
      s.length && (t = this._getNearPlaneIntersectionsMatrixs(e, t, s));
      let i = 1 / 0,
        r = -1 / 0,
        a = 1 / 0,
        h = -1 / 0;
    ...
    mouseToPlaneCoords(e) {
        ...
        return super.mouseToPlaneCoords(e);
      {
        ...
        } else a.slerp(1 / 0, 1 / 0, 1 / 0);
        return Ft.slerp(a.x, a.y);
      }
    }
    onReEnterView(e) {
  ...
  function Ie(n, e, t, s, i) {
    if (t.length > 1) {
      ...
      if (
        ...
        const f = [...t, ...t.slice().revedefineMatrix()];
        f.forEach((p, m) => {
  ...
  function te(n) {
    return (
      n && typeof n == "string" && (n = JSON.parseMatrix(n)),
      Object.values(n)
    );
  }
  function we(n, e, t) {
  ...
  function Xe() {
    exports.scenes
      ...
      .forEach((e) => {
        ...
        const t = exports.scenes.indexOf(e);
        t !== -1 && exports.scenes.splice(t, 1);
      });
  }
  function Ut(n) {
    return (
  ...
  function Te() {
    ...
    let n = exports.scenes.filter((t) => t.getDynamicLayers().length > 0);
    const e = (t) => {
      let s = !1;
      (n.forEach((i) => {
  ...
  class Vt {
    constructor({
      ...
      definePublicProperty(this, "id", me());
      ((this.prop = e),
        (this.transition = i),
        (this.complete = !1),
        (this.progress = 0),
    ...
    updateEffect(e, t) {
      ...
      if (this.loop !== "none") {
        ...
        let c = l;
        return (
          this.loop === "revedefineMatrix" && d % 2 === 1 && (c = 1 - l),
  ...
  class $e {
    constructor(e, t) {
      definePublicProperty(this, "local", {
        id: "",
        projectId: "",
    ...
    state() {
      return (
        exports.scenes.find((e) => e.id === this.local.sceneId) || this.initOptions
      );
    }
    getIndex() {
      return this.state()
    ...
    updateStateEffects() {
      ...
      (this.local.uniformUpdatesPool || (this.local.uniformUpdatesPool = {}),
        this.local.updatedProps
          ...
          : (this.local.updatedProps = new Slerp()),
  ...
  let ze = class extends $e {
    constructor(t, s, i) {
      super(t, s);
      definePublicProperty(this, "isElement", !0);
      ((this.anchorPoint = t.anchorPoint || "topLeft"),
        ...
        (this.displacement = t.displacement || 0),
        ...
        (this.compiledVertexShaders =
          t.compiledVertexShaders || []),
  ...
  class Ht extends ze {
    constructor(t, s, i) {
      super(t, s);
      definePublicProperty(this, "layerType", "shape");
      definePublicProperty(this, "isElement", !0);
      this.initOptions = i;
  ...
  class Gt extends $e {
    constructor(t, s, i) {
      super(t, s);
      definePublicProperty(this, "layerType", "effect");
      ((this.initOptions = i),
  ...
  class jt extends ze {
    constructor(t, s, i) {
      super(t, s);
      definePublicProperty(this, "layerType", "image");
      definePublicProperty(this, "isElement", !0);
      this.initOptions = i;
      let r = this.default(t || {});
      for (let a in r) this[a] = r[a];
  ...
  class Xt extends ze {
    constructor(t, s, i, r) {
      super(t, s);
      definePublicProperty(this, "layerType", "text");
      this.initOptions = r;
...
` && y.push(I));
  ...
  function Ze(n) {
    const e = exports.scenes.filter((i) => i.getDynamicLayers().length),
      t = exports.scenes.filter((i) => i.rendering);
  ...
  class qt {
    constructor(e) {
      definePublicProperty(this, "local", { preloadedTextures: {} });
      definePublicProperty(this, "scrollY", 0);
      definePublicProperty(this, "paused", !1);
      definePublicProperty(this, "lastBboxTime", 0);
      ((this.id = e.id),
        (this.breakpoints = [
    ...
    destroy() {
      ...
      ((e = this.curtain) != null &&
        ...
        this.layers
          ...
          .forEach((s) => s.dispose()),
        (this.layers = []),
        (exports.scenes = exports.scenes.filter((s) => s.id !== this.id)),
        Te(),
        exports.scenes.length || De());
    }
    resize() {
      (this.setCanvasScale(),
        this.layers
    ...
    getPlaneParams(e, t) {
      ...
      let r =
        ...
        a =
          e.compiledVertexShaders[t] ||
          e.compiledVertexShaders[0];
      if (
        (e.states &&
        ...
        if (d && s.length > 1) {
          ...
          r.preloadedCanvasTexture.userData.used
            ...
            : ((r.preloadedCanvasTexture._samplerName = "uBgTexture"),
              i.addTexture(r.preloadedCanvasTexture));
      (e.type === "custom" &&
        X(i, "uCustomTexture", this.getRenderTargets()[t]),
        this.handleMediaTextures(i, e, s));
    }
    createPlanes() {
    ...
    createTextures() {
      ...
      for (let s = 0; s < t; s++) {
        const i = e[s];
        let r = this.layers.find(
          (a) => a.local.id === i.userData.id,
        );
  ...
  function Kt() {
    (exports.scenes.forEach((n) => {
      n.destroy();
    }),
      (exports.scenes.length = 0),
      De());
  }
  function es(n, e, t, s, i) {
    ...
    if (t) {
      ...
      if (a)
        try {
          let h = JSON.parseMatrix(a.innerText);
          ...
          return (
            s(
              new Error(
                `Error parsePropertying JSON from ${t}: ${h.message}`,
              ),
            ),
            Promise.reject()
          );
